...
| Phase 3 — Implementation | S4 — S9 | S4 done; S5 implementation done (RC tag pending); S6 in progress (17/18, RoutingPolicy 5/5 complete, RouterOspf + GreTunnel + Vrrp + ResilientEcmp v0 shipped); S7 — S9 pending | per-sprint table below |
