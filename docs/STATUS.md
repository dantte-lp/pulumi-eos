...
| S6 — L3 family | 18 resources after RoutingPolicy decomposition: `Loopback`, `Vrf`, `Bfd`, `Subinterface`, `StaticRoute`, `RouterBgp`, `PrefixList`, `RouteMap`, `CommunityList`, `ExtCommunityList`, `AsPathAccessList`, `Rcf`, `Rpki`, `RouterOspf`, `GreTunnel`, `Vrrp`, `ResilientEcmp`, `PolicyBasedRouting` (see Tier 2 ordering) | in progress (17/18); RoutingPolicy 5/5 done | shipped: `Loopback` (`5dcc4df`), `Vrf` (`c335d22`), `Bfd` (`eea0e74`), `Subinterface` (`8b2dd6e`), `StaticRoute` (`908af76`), `RouterBgp` v0 (`1574102`), `PrefixList` (`11a4cd6`), `RouteMap` (`d50fc2a` + additive-flag fix `72c7db5`), `CommunityList` (`1566544`), `ExtCommunityList` (`51416dc`), `AsPathAccessList` (`888a110`), `Rcf` v1 (`8e02a46`, supersedes v0 `fbdfbb5`), `Rpki` (`1e93356`), `RouterOspf` v0 (`a059ec1`), `GreTunnel` v0 (`d2ee58a`), `Vrrp` v0 (`9d28327`), `ResilientEcmp` v0 (this commit; platform-only — cEOSLab returns "Unavailable command", production EOS DCS-7050/7160/7280/73xx/75xx/78xx accepts directly per TOI 13938); 33/33 cEOS integration tests pass |
