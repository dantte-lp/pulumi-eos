...
| **S6** | L3 family: `Loopback`, `Vrf`, `Bfd`, `Subinterface`, `StaticRoute`, `RouterBgp` (peer-groups, per-AF, per-VRF, RD/RT, RCF), `RouterOspf`, `RoutingPolicy`, `Rcf`, `Rpki`, `GreTunnel`, `Vrrp`, `PolicyBasedRouting`, `ResilientEcmp`. | Leaf-spine demo (2 leaves + 1 spine, EVPN A-A) deploys end-to-end against cEOS. |
